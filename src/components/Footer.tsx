      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-xl font-display font-bold mb-4">StayEscape</h3>
            <p className="mb-4 text-gray-300 max-w-md">
              Luxury short-term rentals designed for comfort and relaxation. Experience the perfect getaway with our carefully curated properties.
            </p>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300 space-y-2">
              ...
              <p><a href="mailto:info@stayescape.com" className="hover:text-white transition-colors">info@stayescape.com</a></p>
            </address>
          </div>
        </div>
        
        <div className="mt-12 pt-6 border-t border-rental-700/50 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2025 StayEscape. All rights reserved.</p>
